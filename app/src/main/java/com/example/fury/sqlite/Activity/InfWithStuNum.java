...
public class InfWithStuNum extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inf_with_stu_num);
        ...
        query.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                DatabaseHelper dbHelper= new DatabaseHelper(InfWithStuNum.this,
